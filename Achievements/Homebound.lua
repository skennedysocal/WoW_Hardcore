...
homebound_achievement:SetScript("OnEvent", function(self, event, ...)
	...
	if (event == "ZONE_CHANGED") then
	  ...
	  if race_english == "Human" or race_english == "Undead" or race_english == "Dwarf" or race_english == "Gnome" then
	  ...
	  if race_english == "Orc" or race_english == "Night Elf" or race_english == "Tauren" or race_english == "Troll" then
