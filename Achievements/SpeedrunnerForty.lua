...
_G.passive_achievements.SpeedrunnerForty = _achievement

-- General info
_achievement.name = "SpeedrunnerForty"
_achievement.title = "Speedrunner (40)"
...
_achievement.played_time_threshold = 50*60*60
