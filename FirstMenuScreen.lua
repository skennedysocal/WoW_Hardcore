...
function ShowFirstMenu(_hardcore_character, _failure_function_executor)
  ...
  tabcontainer:SetTabs({{value="WelcomeTab", text="General"}, {value="PartyTab", text="Party"}, {value="AchievementsTab", text="Achievements"}})  -- , 
