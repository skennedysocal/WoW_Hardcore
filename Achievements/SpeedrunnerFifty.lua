...
_G.passive_achievements.SpeedrunnerFifty = _achievement

-- General info
_achievement.name = "SpeedrunnerFifty"
_achievement.title = "Speedrunner (50)"
...
_achievement.played_time_threshold = 81*60*60
