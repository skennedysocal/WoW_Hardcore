...
i_can_see_you_achievement.icon_path = "Interface\\Addons\\Hardcore\\Media\\icon_default.blp"
i_can_see_you_achievement.description = "Complete the Hardcore challenge without at any point using Stealth, Shadowmeld or Vanish. Invisibility potions are allowed."
