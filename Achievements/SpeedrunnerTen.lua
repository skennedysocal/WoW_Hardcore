...
_G.passive_achievements.SpeedrunnerTen = _achievement

-- General info
_achievement.name = "SpeedrunnerTen"
_achievement.title = "Speedrunner (10)"
...
_achievement.played_time_threshold = 2*60*60
